...
Generated: 2026-09-14T00:14:09.667Z
...
| --- | --- | --- | --- | --- |
| Ani-Dax | anidax-sprint-1-sample | READY_FOR_APPROVAL_PACKAGE | no | Approve concept/script and final voice/visual style before publishing. |
| God's Vessel | gods-vessel-names-of-god | READY_FOR_DANIEL_REVIEW_AND_VENDOR_SETUP | no | Approve theology, product choices, pricing, vendor setup, and storefront path. |
