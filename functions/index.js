...
// Use your downloaded service account key locally/emulator
admin.initializeApp({
  credential: admin.credential.cert(serviceAccount),
  databaseURL:   'https://dax-collective.firebaseio.com'
});

// If you deploy this to GCP Cloud Functions you can
// comment out the above and just do:
//   admin.initializeApp();
// which picks up the default GCP service account automatically.

// Now grab firestore
const db = admin.firestore();

// …all your exports and helper functions follow here…
