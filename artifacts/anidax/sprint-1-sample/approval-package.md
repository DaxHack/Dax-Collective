...
**In-universe interview beat (10-16s)**
...
| --- | --- | --- | --- |
| 0-4s | Black field, cyan reset loop, single question card. | Is this power, or punishment? | Original motion graphic |
| 4-10s | Timeline fractures into three paths, only one path remains lit. | Control is removed. | Original vector/motion graphic |
| 10-16s | Interview table silhouette, empty second chair, recorder waveform. | What did the last version lose? | Original composition |
| 16-23s | Memory cards stack up behind the narrator frame. | The plot resets. The burden does not. | Original motion graphic |
| 23-30s | Ani-Dax title lockup, no upload CTA until approval. | READY FOR DANIEL REVIEW | Brand card |
